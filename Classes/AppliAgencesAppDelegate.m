...
@implementation AppliAgencesAppDelegate
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"AppliAgences.sqlite"];
	...
	defaultStorePath = [[NSBundle mainBundle] pathForResource:@"AppliAgences" ofType:@"sqlite"];
